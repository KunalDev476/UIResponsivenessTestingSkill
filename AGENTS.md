...
- After generating or updating a responsive QA spec, use the `qa-visual-review-monitor` subagent defined in `ui-responsive-testing-v2/agents/qa-visual-review-monitor.toml` to process pending AI review hooks.
