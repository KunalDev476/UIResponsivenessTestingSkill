...
```
Use the qa-visual-review-monitor monitor agent to process pending AI review hooks. Perform a strict spelling audit with both a line pass and a word/token pass.
```
